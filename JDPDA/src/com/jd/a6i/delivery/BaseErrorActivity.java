...
public class BaseErrorActivity extends JDBaseActivity implements OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		textBoxNo.setText(Html.fromHtml(getResources().getString(R.string.boxNo)));
